        ...
        <div id={styles.homepage}>
            ...
            <main>
                ...
                <Dialog open={open} PaperProps={{ style: styling.dialogPaper }}>
                    <span style={{ marginLeft: 'auto' }} onClick={() => { handleDialog() }} className='hoverable'>
            ...
            <div id={styles.githubSection}>
                <div className={styles.gitItem} id={styles.gitDescription}>
                    ...
                    <p className={styles.gitGradient}>SharePictures is fully open source and could be accessed <a href='https://github.com/bogyz123/sharepictures' className="link" target="_blank" id={styles.githubLink}>here</a></p>
                </div>
